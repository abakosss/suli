...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-brand">
      ...
      <ul class="dropdown-menu">
        <?php if (isset($_SESSION['username'])): ?>
          ...
          <li id="logout_button" onclick="logout()"><a class="dropdown-item" href="index.php">Kijelentkezés</a></li>
        <?php else: ?>
    ...
    <div class="mx-auto text-center">
      <a class="h1 text-white" href="index.php" role="button" style="text-decoration: none;">szilyProjekt</a>
    </div>
  </div>
</nav>
